...
rc=0
for s in terminal agents providers provenance layout layout-move archive actions runtime activity browser towns github usage config diagnostics continuity system; do
  echo "=== $s"
