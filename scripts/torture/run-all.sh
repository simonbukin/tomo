...
rc=0
for s in terminal agents providers provenance layout layout-move archive actions runtime activity browser agentation towns github usage config diagnostics continuity system; do
  echo "=== $s"
