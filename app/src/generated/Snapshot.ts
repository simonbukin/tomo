 ...
 */
export type Snapshot = { status: Status, config: Config, repos: Array<Repo>, worktrees: Array<Worktree>, tabs: Array<Tab>, panes: Array<Pane>, agents: Array<AgentPresence>, attention: Array<AttentionItem>, resources: Array<WorktreeResources>, ui_state: unknown, };
