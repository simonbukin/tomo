...
export const actions: Action[] = [
  ...
  { id: "hide_repo", label: "Hide this repo", run: () => setRepoHidden(currentWorktree()!.repo_id, true), whenWorktree: true, when: () => !getState().ui.hiddenRepos.includes(currentWorktree()?.repo_id ?? "") },
