...
export const MENU_BAR_LAYOUT: { text: string; items: LayoutItem[] }[] = [
  ...
  { text: "View", items: ["palette", SEP, "home", "activity", "agents", ...addonViews().map((v) => v.id), "toggle_board", SEP, "toggle_left_sidebar", "toggle_right_sidebar", SEP, "zoom_in", "zoom_out", "zoom_reset", SEP, p("Minimize"), p("Fullscreen")] },
