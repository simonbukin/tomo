...
/** The first HTTP endpoint of a worktree: the NOW signal, and the "Open App" link of an item without a URL. */
export const primaryEndpoint = (s: State, worktreeId: Id): RuntimeEndpoint | null => httpEndpoints(endpointsOf(s, worktreeId))[0] ?? null;
